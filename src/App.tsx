...
export default function App() {
  ...
  const filteredTransactions = transactions.filter(
    (t) =>
      (t.created_at ? new Date(t.created_at) : new Date()).getMonth() ===
      selectedMonth,
  );
  ...
  const progressPercent = Math.min(
    Math.round(balance > 0 ? (balance / reserveGoal) * 100 : 0),
    100,
  );
        ...
        <div className="auth-side-form">
          <div className="auth-card-box">
            <div className="auth-logo">
              <Wallet size={42} /> <span>FocusFinance</span>
            </div>
        ...
        <div className="app-col-primary">
          <section className="app-glass-section reserve-goal-box">
            <div className="section-title-row">
              ...
              <span className="meta-info-badge">
                Meta: R$ {reserveGoal.toLocaleString()}
              </span>
            </div>
        ...
        <aside className="app-col-side">
          <div className="app-ai-insight-box">
            <div className="ai-box-header">
              <BrainCircuit /> IA Consultora
            </div>
            <p>
              {balance < reserveGoal
                ? "Seu saldo atual deve ser focado na construção da sua reserva de 6 meses. Evite gastos variáveis."
                : "Excelente! Reserva concluída. Hora de diversificar em FIIs e Ações de dividendos."}
            </p>
          </div>
