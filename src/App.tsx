...
const ESSENCIAIS = ["Salario", "Taxa Cartorial","Feira Domingo","Açougue", "Condominio", "FAM", "TIM","Carregador","Mercado", "ENEL", "CLARO","VIVO", "Academia", "CLOUDDY", "Apple", "Cartão da Larissa", "Nubank","Condução","Bomboniere", "VT+ ALIMENTAÇÃO"];
