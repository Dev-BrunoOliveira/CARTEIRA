...
const ESSENCIAIS = ["Salario", "Taxa Cartorial","Feira Domingo","Açougue", "Condominio", "FAM", "TIM","Carregador","Mercado", "ENEL", "CLARO", "Academia", "CLOUDDY", "Apple", "Cartão da Larissa", "Nubank","Condução", "VT+ ALIMENTAÇÃO"];
